...
public abstract class CoordinateSystem3D {
	 ...
	 * @param gl
	 */
	public void initAxesLabeling(GL gl) {
	 ...
	 * @param timepoints 
	 */
	public abstract void drawLabeling(GL gl, double[] rotation, double[] timepoints);
	/**
	 * draw labels without time points
	 * @param gl
	 * @param rotation
	 */
	public void drawLabeling(GL gl, double[] rotation) {
