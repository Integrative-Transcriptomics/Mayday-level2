...
public class Chi2TestPlugin extends SNVListPlugin {
	...
	public String getType() {
		return "statistics.chi2";
	}

	@Override
	public String getDescription() {
		return "Chi2-Test for 2x2 contingency tables";
	}
	...
	public void run(Collection<SNVList> snpLists) {
		...
		RevealTask task = new RevealTask("Chi2-Test", getProjectHandler()) {
