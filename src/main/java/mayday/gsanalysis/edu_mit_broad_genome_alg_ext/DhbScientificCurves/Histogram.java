...
import mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbEstimation.WeightedPoint;
...
import mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbStatistics.FixedStatisticalMoments;
...
public class Histogram implements PointSeries {
    ...
    /**
     * @param pdf edu.mit.broad.genome.alg.ext.DhbStatistics.ScaledProbabilityDensityFunction
    ...
    /**
     * @return edu.mit.broad.genome.alg.ext.DhbEstimation.WeightedPoint	corresponding to bin n.
     * @param n int
     */
