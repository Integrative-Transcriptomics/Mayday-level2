...
import mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbIterations.IncompleteGammaFunction;
...
public class GammaDistribution extends ProbabilityDensityFunction {
    ...
    /**
     * @return edu.mit.broad.genome.alg.ext.DhbIterations.IncompleteGammaFunction
     */
    private IncompleteGammaFunction incompleteGammaFunction() {
