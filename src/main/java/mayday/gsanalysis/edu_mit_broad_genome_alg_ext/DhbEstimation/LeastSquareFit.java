...
import mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbInterfaces.ParametrizedOneVariableFunction;
...
public class LeastSquareFit extends IterativeProcess {
    ...
    /**
     * @return edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.SymmetricMatrix	the error matrix of the fit.
     */
