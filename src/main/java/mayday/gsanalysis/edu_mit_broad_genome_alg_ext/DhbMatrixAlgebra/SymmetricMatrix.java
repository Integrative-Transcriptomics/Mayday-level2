...
public class SymmetricMatrix extends Matrix {
     ...
     * @return edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.SymmetricMatrix
     ...
     * @exception mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbMatrixAlgebra.DhbIllegalDimension
     * 			The supplied components are not those of a square matrix.
     * @exception mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbMatrixAlgebra.DhbNonSymmetricComponents
    ...
    /**
     * @return edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.Matrix	product of the receiver with
     * 								the transpose of the supplied matrix
     * @param a edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.Matrix
     * @exception mayday.gsanalysis.edu_mit_broad_genome_alg_ext.DhbMatrixAlgebra.DhbIllegalDimension If the number of
     ...
     * @return edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.SymmetricMatrix
     * @param a edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.SymmetricMatrix
     */
     ...
     * @return edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.Matrix[]	Array of splitted matrices
     */
    ...
    /**
     * @return edu.mit.broad.genome.alg.ext.DhbMatrixAlgebra.SymmetricMatrix	product of the tranpose
