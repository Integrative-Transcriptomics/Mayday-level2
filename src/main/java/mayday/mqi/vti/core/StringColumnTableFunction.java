...
Derby - Class sun.javadb.vti.core.StringColumnTableFunction
 ...
 * methods. Subclasses must implement the following public ResultSet methods:
 * </p>
 *
 * <ul>
 * <li>next( )</li>
 ...
 *
 * <ul>
 * <li>{@link #getRawColumn( int ) getRawColumn( int columnNumber )}</li>
 * </ul>
 *
 *    <img src="../../../../JavaDB.png"/>
 */
public  abstract    class   StringColumnTableFunction extends TemplateTableFunction
{
    ///////////////////////////////////////////////////////////////////////////////////
    //
    // CONSTANTS
    ...
    public	final	class	SimpleBlob	implements	Blob
    {
        ...
        public	InputStream	getBinaryStream( long position, long length )
            throws SQLException
        {
            int     pos = castLong( position );
            int     len = castLong( length );
            
            return new ByteArrayInputStream( _bytes, pos, len );
        }
     ...
     * </p>
     */
    public	final	class	SimpleClob	implements	Clob
    {
            ...
            throws SQLException
        {
            ...
            return new CharArrayReader( _contents.toCharArray(), pos, len );
        }
     ...
     * </p>
     */
    public  StringColumnTableFunction( String[] columnNames )
    {
   ...
   public float getFloat(int columnIndex) throws SQLException
   {
     ...
     * </p>
     */
    protected   int getColumnCount() { return _columnNames.length; }
    
    ///////////////////////////////////////////////////////////////////////////////////
    //
    // PROTECTED MINIONS FOR RE-USE BY SUBCLASSES
    //
    ///////////////////////////////////////////////////////////////////////////////////
    ...
    private int castLong( long value )
        throws SQLException
    {
        if ( value > Integer.MAX_VALUE )
        {
            throw new SQLException( "Long value " + value + " will not fit in a 4 byte integer." );
        }
