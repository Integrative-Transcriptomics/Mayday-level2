...
public class CoverageSummary extends AbstractTransformationPlugin {
	...
	public void compute() {		
		for (Experiment e : transMatrix.getExperiments(this)) {
			...
			transMatrix.setIntermediateData(e, 
					new CoverageSummaryExperimentData(e, (LocusReadCountData)ex)
			);
		}	
	}
	...
	public PluginInfo register() throws PluginManagerException {
		return new PluginInfo(
				this.getClass(), 
				MC+".CombineReads.Coverage", 
				new String[0], 
				MC, null, 
				"Florian Battke", 
				"battke@informatik.uni-tuebingen.de", 
				"Use the coverage of a locus (number of bases in covering reads / number of bases in locus) as expression summary", 
		"Compute expression from coverage");
	}
