...
public class RPMSummary extends AbstractTransformationPlugin {
	...
	public void compute() {		
		for (Experiment e : transMatrix.getExperiments(this)) {
			...
			transMatrix.setIntermediateData(e, 
					new RPMSummaryExperimentData(e, (LocusReadCountData)ex, transMatrix.getInputState(this, e).getNumberOfFeatures())
			);
		}	
	}
	...
	public PluginInfo register() throws PluginManagerException {
		return new PluginInfo(
				...
				"Combine read counts into an expression level for a given locus using the \"reads per million\" measure.", 
		"Combine Read Counts (RPM) -- reads per million mapped");
	}
