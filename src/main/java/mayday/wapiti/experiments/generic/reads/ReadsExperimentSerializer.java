...
public class ReadsExperimentSerializer extends
	...
	protected ReadsExperiment loadDataFromStream(String name, String sourceDescription, TransMatrix tm, DataInputStream dis)
		...
		rd.getFullData().read(dis,0); // changed to read old datasets but store them in the new format
