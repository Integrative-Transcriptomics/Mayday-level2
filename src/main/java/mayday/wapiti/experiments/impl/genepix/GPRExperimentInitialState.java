...
public class GPRExperimentInitialState extends FeatureExpressionInitialState {

	public GPRExperimentInitialState(FeatureExpressionExperiment dataSetExperiment) {
	...
	public DataProperties getDataProperties() {
		...
		dp.add(new FlagsPresent(GPRExperimentData.FLAGTYPES));
		return dp;
	}
