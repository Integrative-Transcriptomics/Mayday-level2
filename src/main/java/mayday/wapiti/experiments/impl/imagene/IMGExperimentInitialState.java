...
public class IMGExperimentInitialState extends FeatureExpressionInitialState {

	public IMGExperimentInitialState(FeatureExpressionExperiment dataSetExperiment) {
	...
	public DataProperties getDataProperties() {
		...
		dp.add(new FlagsPresent(IMGExperimentData.FLAGTYPES));
		return dp;
	}
