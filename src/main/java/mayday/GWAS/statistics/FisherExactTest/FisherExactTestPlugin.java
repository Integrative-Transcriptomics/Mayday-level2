package mayday.GWAS.statistics.FisherExactTest;
...
public class FisherExactTestPlugin extends SNPListPlugin {
	...
	public String getType() {
		return "statistics.fisherexact";
	}

	@Override
	public String getDescription() {
		return "Fisher's Exact Test for 2x2 contingency tables";
	}
	...
	public void run(Collection<SNPList> snpLists) {
		...
		RevealTask task = new RevealTask("Fisher's Exact Test", getProjectHandler()) {
