package mayday.tiala.multi.mio;
...
public class AlignmentMIO extends GenericMIO<Map<String,String>> {
	...
	public final static String myType = "PAS.MIO.alignedDS.Alignment2";
...
//	private final static String PREFIX_LINKEDPROBELIST = "Link";
	...
	public boolean deSerialize(int serializationType, String serializedForm) {
		...
		case MIType.SERIAL_TEXT:
			...
			//FIXME: is this really intended? FALL-THROUGH?
...
//		}
	...
	public void setTimeShifts(TimeShifts shifts) {
		//FIXME does arrays.tostring really work in this case?!
		Value.put(KEY_TIMESHIFT, Arrays.toString(shifts.toArray()));
	}
