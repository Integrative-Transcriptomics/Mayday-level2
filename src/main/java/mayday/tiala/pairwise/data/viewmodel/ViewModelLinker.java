...
import mayday.tiala.pairwise.data.probelists.MirrorProbeList;
...
public class ViewModelLinker {
	...
	public ViewModelLinker( ViewModel... viewModels ) {
...
//	protected Iterable<ViewModel> allModels() {
//		return new Iterable<ViewModel>() {
//			public Iterator<ViewModel> iterator() {
//				return new Iterator<ViewModel>() {
//					protected boolean inInput = true;
//					protected Iterator<ViewModel> myIt = inputModels.iterator();
//					public boolean hasNext() {
//						if (!myIt.hasNext() && inInput) {
//							inInput = false;
//							myIt = outputModels.iterator();
//						}							
//						return myIt.hasNext();
//					}
